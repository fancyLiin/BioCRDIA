...
TRAIN_DATA_PATH = "../train_data_taxsft/biocrdia_vanilla_train.json"
VAL_DATA_PATH = "../train_data_taxsft/biocrdia_vanilla_val.json"
...
def main():
    ...
    print("=" * 80)
    print("BioCRDIA Vanilla SFT Training on TaxData")
