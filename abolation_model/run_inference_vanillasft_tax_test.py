...
LORA_PATH = "/root/autodl-tmp/saves/BioCRDIA-7B-VanillaSFT-TaxData"
...
OUTPUT_FILE = os.path.join(
    OUTPUT_DIR,
    "predictions_BioCRDIA-7B-VanillaSFT-TaxData_TaxTest.json"
)
...
def main():
    ...
    print("=" * 80)
    print("Zero-shot inference on BioCRDIA Tax Test")
    ...
    print(f"Running zero-shot inference on {len(test_data)} samples...")
    ...
    print("=" * 80)
    print("Zero-shot inference finished.")
